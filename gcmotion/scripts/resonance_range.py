...
def omegas_max(
    ...
    **kwargs,
    ...
    freq_units_zeta : str, optional
        ...
        Returns
        -------
        Tuple of all the :math:`\omega_\theta` and :math:`\omega_\zeta`s at
        the O points for the different :math:`P_{\zeta}`'s or :math:`\mu`'s
    """
    # Unpack parameters
...
def _omegas_maxNU(
    ...
    logger.info(f"Calculated {omega_zeta_max=}")
